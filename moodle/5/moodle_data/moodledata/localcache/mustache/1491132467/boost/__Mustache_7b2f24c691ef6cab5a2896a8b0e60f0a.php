...
class __Mustache_7b2f24c691ef6cab5a2896a8b0e60f0a extends Mustache_Template
{
...
';
        ...
        $buffer .= '" aria-controls="nav-drawer" type="button" class="btn pull-xs-left m-r-1 btn-secondary" data-action="toggle-drawer" data-side="left" data-preference="drawer-open-nav"><span aria-hidden="true">&#9776;</span><span class="sr-only">';
        // 'str' section
