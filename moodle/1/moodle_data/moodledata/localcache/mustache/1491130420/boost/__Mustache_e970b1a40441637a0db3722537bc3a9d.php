...
class __Mustache_e970b1a40441637a0db3722537bc3a9d extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $buffer .= $value;
        $buffer .= '" class="filemanager fm-loading">
';
...
';
        $buffer .= $indent . '    </div>
';
        $buffer .= $indent . '    <div class="fp-navbar bg-faded card m-b-0">
';
