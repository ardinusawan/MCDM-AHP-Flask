...
class __Mustache_048a58feb293a30a8c091e4234a53266 extends Mustache_Template
{
...
';
        $buffer .= $indent . '    <div class="fp-repo-area col-md-3 nav nav-pills nav-stacked">
';
        $buffer .= $indent . '            <div class="fp-repo nav-item">
';
        $buffer .= $indent . '                <a href="#" class="nav-link"><img class="fp-repo-icon" alt=" " width="16" height="16" />&nbsp;<span class="fp-repo-name"></span></a>
';
        $buffer .= $indent . '            </div>
';
        $buffer .= $indent . '
...
';
        ...
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section6d2eac10b09284afdc0013ef49e4644c($context, $indent, $value);
        $buffer .= '" class="btn btn-secondary btn-sm" href="#">
';
        $buffer .= $indent . '                                ';
        // 'pix' section
...
';
    ...
    private function section6d2eac10b09284afdc0013ef49e4644c(Mustache_Context $context, $indent, $value)
    {
        $buffer = '';
        $blocksContext = array();
