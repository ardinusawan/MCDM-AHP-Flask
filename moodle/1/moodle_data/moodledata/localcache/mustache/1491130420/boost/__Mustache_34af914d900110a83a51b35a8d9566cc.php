...
class __Mustache_34af914d900110a83a51b35a8d9566cc extends Mustache_Template
{
    ...
    public function renderInternal(Mustache_Context $context, $indent = '')
    {
        ...
        $blocksContext['headeractions'] = array($this, 'block8f856f69f3dea665079b5d97e8aa0512');
...
';
    ...
    public function block6fca0824368be626a52c5a784e52aa46($context)
    {
        $indent = $buffer = '';
        $blocksContext = array();
...
';
    ...
    public function block92f82d55ae6ccb2bfaba63cdf0fa0399($context)
    {
        $indent = $buffer = '';
        $blocksContext = array();
        $buffer .= '                <a href="';
...
';
    ...
    public function block8f856f69f3dea665079b5d97e8aa0512($context)
    {
        $indent = $buffer = '';
        $blocksContext = array();
        $buffer .= '        ';
        
        $blocksContext['anchor'] = array($this, 'block6fca0824368be626a52c5a784e52aa46');
        ...
        $blocksContext['anchor'] = array($this, 'block92f82d55ae6ccb2bfaba63cdf0fa0399');
        $blocksContext['tooltip'] = array($this, 'block725023d485c4d78efe719bf0b8598c80');
