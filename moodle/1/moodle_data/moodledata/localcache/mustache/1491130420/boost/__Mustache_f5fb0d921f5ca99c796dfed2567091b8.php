...
class __Mustache_f5fb0d921f5ca99c796dfed2567091b8 extends Mustache_Template
{
...
';
        $buffer .= $indent . '                    <label class="form-control-label col-xs-4">';
        // 'str' section
        $value = $context->find('str');
        $buffer .= $this->section59a2a4641027716ff85403c2d5e94fc1($context, $indent, $value);
        $buffer .= '</label>
';
        $buffer .= $indent . '                    <div class="col-xs-8"><input class="form-control" type="text"/></div>
';
        $buffer .= $indent . '                </div>
';
